...
public class Les28112222 {
    ...
    public static String parolGeneration(int pasLenght) {
        final String LOWER = "abcdefghijklmnopqrstuvwxyz";
        final String UPPER = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        final String DIGITS = "0123456789";
        final String PUNCTUATION = "!@#$%&*()_+-=[]|,./?><";
        final String total = LOWER + UPPER + DIGITS + PUNCTUATION;
        Random random = new Random();
        String password = "";
//        ULDP...other
        while (pasLenght < 8) {
            System.out.println("Vvedite ne menche 8 simvolov");
            pasLenght = scanner.nextInt();
        }
        ...
        for (int i = 0; i < pasLenght-4; i++) {
            password += total.charAt(random.nextInt(total.length()));
        }
        return password;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(parolGeneration(1000000));
    }
}
